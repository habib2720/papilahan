...
const Katalog = () => {
  ...
  useEffect(() => {
    const token = localStorage.getItem("token");
    const id_pencari = jwtDecode(token).id;
    getLahan(id_pencari);
  }, []);
          ...
          <div className="navbar navbar-expand-lg p-3 fw-bold">
            <div className="container-xl">
              ...
              <ul className="navbar-nav mx-auto justify-content-center h3">
                ...
                <li className="nav-item text-white me-lg-5 me-0">
                  <Link className="nav-link" to="/katalog-pencari">
                    Katalog
                  </Link>
                </li>
                <li className="nav-item text-white me-lg-5 me-0">
      ...
      <div className="page-wrapper mt-0 mt-md-5 mt-lg-5">
        <div className="page-body">
          <div className="container-fluid mt-4">
            <div className="row">
              <aside className="col-lg-3 filter-section bg-light p-4 rounded shadow-sm mb-5">
